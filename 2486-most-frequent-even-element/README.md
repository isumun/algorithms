<h2><a href="https://leetcode.com/problems/most-frequent-even-element">2486. Most Frequent Even Element</a></h2><p>Given an integer array <code>nums</code>, return <em>the most frequent even element</em>.</p>
